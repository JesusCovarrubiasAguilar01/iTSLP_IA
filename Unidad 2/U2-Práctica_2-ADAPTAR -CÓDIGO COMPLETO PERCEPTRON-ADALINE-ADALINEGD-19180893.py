...
#############################################################################
print(50 * '=')
print('Impresion de la calidad del vino')
print(50 * '-')

X = df[["fixed acidity", "volatile acidity"]].values  
y = np.where(df["quality"] > 6, 1, -1)

plt.scatter(X[y == 1, 0], X[y == 1, 1], color='r', marker='o', label='Buena Calidad')
plt.scatter(X[y == -1, 0], X[y == -1, 1], color='g', marker='x', label='Mala Calidad')
...
#############################################################################
print(50 * '=')
print('Impresion del modelo Perceptron')
print(50 * '-')
...
print(50 * '=')
print('Implementando una neurona lineal adaptativa en Python')
print(50 * '-')
